...
pub struct DivansDecompressorState {
    ...
    pub decompressor: ::DivansDecompressor<<DecompressorFactory as ::DivansDecompressorFactory<SubclassableAllocator<u8>, SubclassableAllocator<::CDF2>, SubclassableAllocator<::DefaultCDF16>>>::DefaultDecoder,
