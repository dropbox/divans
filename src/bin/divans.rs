...
type BrotliFactory = divans::BrotliDivansHybridCompressorFactory<ItemVecAllocator<u8>,
                                                                 ...
                                                                 brotli::enc::CombiningAllocator<
                                                                     ...
                                                                     ItemVecAllocator<brotli::enc::v8>,
                                                                     ItemVecAllocator<brotli::enc::s16>,
...
fn compress_raw<Reader:std::io::Read,
    ...
    if use_brotli {
        let combined_alloc = brotli::enc::CombiningAllocator::new(
            ...
            ItemVecAllocator::<brotli::enc::v8>::default(),
            ItemVecAllocator::<brotli::enc::s16>::default(),
